...
a student that took Anthro 101
...
-   What did this do? What are the roles of `students_1` (the *left* table) and `enrollments_1` (the *right* table)? A and B (who have enrollment info)
...
-   What did this do? What are the roles of `students_1` (the *left* table) and `enrollments_1` (the *right* table)? all and all 

-   What, if anything, would change if we reversed the order of the data tables? Think about it, then try. Same data diff order
...
-   What did this do? What info would it give us? Enrollment info only
