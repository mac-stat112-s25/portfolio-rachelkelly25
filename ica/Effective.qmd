...
```{r}
#| fig-cap: "Morning and Afternoon Temps in 3 Australian Cities, source: https://mac-stat.github.io/data/weather_3_locations.csv"
...
\ I chose Obama's budget graphic. The size of the bubble is how much money goes to that cause. The color shows the cut or increase from previous budgets.  The projected deficit looks like a huge problem, but it was actually getting significantly better since 2008, so that could be misleading. 
\ I really like the visual choices of this one. The movement between tabs is super cool and I think it's easy to understand and interact with.
\ Great way to show some complex data.
...
We talked about these as a table in class. 
...
\ a dolphin? Hidden in the shadows?
\
\
\
