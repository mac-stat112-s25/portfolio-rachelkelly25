...
Got rid of year and island, then averaged the more specific measurements.
...
-   `pivot_longer()`
-   `pivot_wider()`
-   pivot_longer()' is what you use to obtain the dataset
...
Reaction time gets worse when there is less sleep. 
-   Is this the same for everybody? What differs?
Some people have overall slower or faster reaction times and some people are more heavily impacted by lack of sleep. 
